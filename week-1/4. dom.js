/**
 ...
 - functionality should be in javascript file

Create counter:
 - create an html file and render a number, an increase button, a decrease button
 - create a javascript file and implement the increase and decrease functionality.
